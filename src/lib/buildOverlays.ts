import type { ColorOption, OverlayEntry, StaticLogoOption } from "@/types/preview";

// ── Jersey layer images ──
import stripeImgLayer from "@/assets/jerseys/layers/front-stripes-layer.png";
import backStripeImgLayer from "@/assets/jerseys/layers/back-stripes-layer.png";
import brandImg from "@/assets/jerseys/layers/kcs-logo-layer.png";
import leftChestImg from "@/assets/jerseys/layers/crest-logo-layer.png";
import rightLogoGaaImg from "@/assets/jerseys/layers/gaa-logo-layer.png";
import rightLogoCamogieImg from "@/assets/jerseys/layers/camogie-logo-layer.png";
import rightLogoLgfaImg from "@/assets/jerseys/layers/lgfa-logo-layer.png";
import sponsorLogoImg from "@/assets/jerseys/layers/sponsor-logo-layer.png";
import backSponsorLogoImg from "@/assets/jerseys/layers/back-sponsor-logo-layer.png";
import leftSleeveLogoImg from "@/assets/jerseys/layers/left_sleeve_logo.png";
import rightSleeveLogoImg from "@/assets/jerseys/layers/right_sleeve_logo.png";

// ── Half Zip layer images ──
import halfZipLeftChestLayer from "@/assets/zip-tops/layers/left_chest_logo_layer.png";
import halfZipRightChestLayer from "@/assets/zip-tops/layers/right_chest_logo_layer.png";

// ── CrewNeck layer images ──
import crewNeckLeftChestLayer from "@/assets/crewnecks/layers/left_logo_layer.png";
import crewNeckRightChestLayer from "@/assets/crewnecks/layers/right_logo_layer.png";
import crewNeckBackLayer from "@/assets/crewnecks/layers/back_logo_layer.png";
